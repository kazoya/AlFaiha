...
const items = [
  { title: "جملة الإغلاق", text: "المهندس يريد إضافة خرسانة تطابق المواصفة. المنصة تقترح وأنت تعتمد" },
  { title: "ما يدرَّب عليه المندوب", text: "يعيد الوعد كما هو: مطابقة إضافة خرسانة لمشروع لا تُسعَّر إلا بعد اعتمادك ثم يحول الرسالة بطاقة." },
