...
export const siteConfig = {
  nameAr: "الفيحاء للمنتجات الهندسية",
  nameEn: "Al Faiha Group",
  brandLine: "AL FAIHA",
  productName: "تصور مبيعات كيماويات إنشاءات منذ 1987",
  parentAr: "الفيحاء للمنتجات الهندسية",
  parentEn: "Al Faiha Group",
  recipient: "مدير المبيعات",
  recipientRole: "الفيحاء للمنتجات الهندسية",
  country: "الأردن",
  city: "عمّان",
  cityDetailAr: "عمّان، الأردن",
  since: 0,
  websiteUrl: "https://alfaihagroup.com/",
  defaultMapsUrl: "",
  defaultWhatsAppPhone: "962799774550",
  defaultWhatsAppPrefill: "السلام عليكم الفيحاء للمنتجات الهندسية بخصوص ",
  defaultEmails: ["marya.alalawneh@alfaihagroup.com"] as const,
  phones: ["962799774550"] as const,
  salesPhone: "962799774550",
