...
export function DiscoveryForm() {
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      <PageHeader title="تقييم اكتشاف الفيحاء للمنتجات الهندسية" description="أسئلة المصنع والمبيعات وقناة التشغيل. يُحفظ في هذا المتصفح فقط." demo={false} />
      ...
      <Card className="shadow-sm">
        ...
        <CardContent className="space-y-4">
          ...
          {step === 2 ? (
            <>
              <Field label="هل توجد قناة «مشاريع مقاولات» اليوم؟" name="schoolChannel" register={form.register} />
