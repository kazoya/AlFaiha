...
export const contestRules = [
  { title: "التسجيل", text: "التسجيل من واتساب المبيعات. تُفتح بطاقة مشاريع مقاولات." },
  ...
  { title: "البيع", text: "مطابقة إضافة خرسانة لمشروع لا تُسعَّر إلا بعد اعتمادك" },
  { title: "الصدق", text: "الموقع الحالي «قريباً» بلا كتالوج. نبني على ما هو معلن عن نشاط الشركة دون اختراع أصناف." },
];
